    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div class="col-lg-6 col-7">
                <h2 class="h2 text-dark d-inline-block mb-0">Product Management <small>[new]</small></h2>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="inp_title" class="form-control get-title" type="text" name="title"
                                    value="{{$product['title']}}" placeholder="Enter a title">
                            </div>

                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="inp_price"><b>Price</b> </label>
                                        <input id="price" class="form-control" type="text" name="description"
                                            value="{{$product['price']}}" placeholder="Enter a description">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="inp_description" class="form-control" type="text" name="description"
                                             placeholder="Enter a description">{{$product['description']}}</textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-10  cropping-elements mb-4">
                            <div class="image_container">
                                <img id="inp_image_pre"
                                    src="{{asset(Config::get('images.image_path').'crop/'.$product->image->name)}}"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <h6 class="text-center responsive-moblile">
                                    ...
                                    <input id="submit-btn" type="submit" class="btn btn-success" value="Update">
                                </h6>
                            </div>
                        </div>
                    </div>
