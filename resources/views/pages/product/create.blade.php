...
<div class="row justify-content-center">
    <div class="col-lg-8 ml-5 ">
        <div class="card">
            <div class="card-body">
                <form action="{{route('product.store')}}" enctype="multipart/form-data" method="post" id="activity-type-data">
                    @csrf
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="inp_price" class="form-control" type="text" name="price"
