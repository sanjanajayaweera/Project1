...
<div class="row justify-content-center">
    <div class="col-lg-8 ml-5 ">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('tag.update',$tag['id']) }} "enctype="multipart/form-data"method="post">
                    @csrf
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="inp_title" class="form-control get-title" type="text" name="title"
                                    value="{{$tag['title']}}" placeholder="Enter a title">
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        placeholder="Enter a description">{{$tag['description']}} </textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-10  cropping-elements mb-4">
                            <div class="image_container">
                                <img id="inp_image_pre" src="{{asset(Config::get('images.image_path').'crop/'.$tag->image->name)}}" style="width:100%" alt="your image" />
                            </div>
                        </div>
                    <div>
